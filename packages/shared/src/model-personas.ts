...
export const defaultModelPersonas: ModelPersona[] = [
  ...
  {
    key: 'quantum-sprinter',
    name: 'Quantum Sprinter',
    tagline: 'GPT-5 mini for instant responses and rapid drafting.',
    bestFor: [
      'High-volume drafting and rewriting',
      'Fast tool-calling and automation scaffolds',
      'Light analysis with quick turnarounds',
    ],
    speed: 'fastest',
    cost: 'medium',
    contextLength: 'medium',
    ...
    modelId: 'gpt-5-mini',
    recommended: true,
    recommendedReason: 'Next-gen speed with better reasoning than 4o mini for quick loops.',
  },
  {
    key: 'horizon-analyst',
    name: 'Horizon Analyst',
    tagline: 'Balanced GPT-5 for research, planning, and multimodal briefs.',
    bestFor: [
      'Mixed text+image research summaries',
      'Project plans and multi-step breakdowns',
      'Product specs or user story drafts',
    ],
    speed: 'faster',
    cost: 'high',
    contextLength: 'long',
  ...
  {
    key: 'sentinel-strategist',
    name: 'Sentinel Strategist',
    tagline: 'GPT-5 Pro with longest context and high compliance.',
    bestFor: [
      'Executive strategy docs and trade-off analysis',
      'Compliance-sensitive communications',
      'Longform outlines with deep reasoning',
    ],
    speed: 'fast',
    cost: 'high',
    contextLength: 'long',
