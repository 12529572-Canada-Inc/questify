...
function getStore(): PersonaTelemetryStore {
  ...
  if (!globalStore[GLOBAL_KEY]) {
    globalStore[GLOBAL_KEY] = {
      model_persona_viewed: { total: 0, byPersona: {}, bySurface: {} },
      model_persona_hovered: { total: 0, byPersona: {}, bySurface: {} },
      model_persona_selected: { total: 0, byPersona: {}, bySurface: {} },
      model_persona_recommended_shown: { total: 0, byPersona: {}, bySurface: {} },
      model_persona_recommended_accepted: { total: 0, byPersona: {}, bySurface: {} },
    }
  }
